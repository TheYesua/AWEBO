...
de **Bachillerato de las cinco**: País Vasco (Decreto 76/2023), Cataluña
...
Bachillerato), Ceuta y Melilla (Orden EFP/755/2022, hermana de la de la ESO) y
Galicia (Decreto 157/2022, hermano del 156/2022 y del mismo día).
...
**1370 tests** cubren todo lo anterior, en la batería que corre en cada push.
...
| ~~6~~ | ~~Internacionalización (i18n)~~                 | L        | ✅ 08/08 · 596 cadenas en es/ca/gl/eu |
...
| ~~9b~~ | ~~Ampliación: más etapas (Bachillerato)~~      | M        | ✅ **las cinco comunidades** |
...
- FP queda fuera del alcance: no comparte estructura con la ESO ni con
